...
3. 게임 안 1:1 대화창에서 `Log` 버튼을 눌러 켭니다. 켜진 뒤 상대방이 채팅을 치면 에타 레벨이 표시됩니다.

   | Log 꺼짐 | Log 켜짐 |
   |:---:|:---:|
   | <img src="docs/log_off.png" alt="Log 버튼 꺼짐" width="380"> | <img src="docs/log_on.png" alt="Log 버튼 켜짐" width="380"> |

4. 상태 창의 설정에서 폰트 및 위치, 테일즈위버 경로 설정을 바꿀 수 있습니다.
5. 최소화하면 트레이로 들어가고, 트레이 아이콘을 두 번 누르면 다시 열립니다.
6. 새 버전이 나오면 상태 창에 알림이 뜨고, 업데이트를 누르면 바로 바뀝니다.
